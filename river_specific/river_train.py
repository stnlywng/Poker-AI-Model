...
def collate_poker_batch(batch):
    ...
    max_len = min(max_len, 30)  # Cap at 30 actions to prevent excessive padding
...
class PokerDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        size_label = float(size_label) / self.data[idx]['river_gamestate']['blinds']  # Normalize by blinds
