...
from river_testing_samples import *


def load_model(model_path='../models/poker_model_river.pth'):
...
def create_sample_gamestate(hole_cards, flop_cards, turn_card, river_card, position, num_players, blinds, stacks, ante, preflop_actions, flop_actions, turn_actions, actions):
...
def main():
    ...
    while True:
        ...
        hole_cards, flop_cards, turn_card, position, num_players, blinds, ante, stacks, preflop_actions, flop_actions, actions = sample_three()
