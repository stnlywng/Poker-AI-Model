def sample_zero():
    ...
    turn_actions = [
        {'action': 'checks', 'amount': 0, 'player': 'bb'},
        {'action': 'bets', 'amount': 200, 'player': 'lj'},
    ...
    return hole_cards, flop_cards, turn_card, river_card, position, num_players, blinds, ante, stacks, preflop_actions, flop_actions, turn_actions, actions
...
def sample_one():
    ...
    turn_actions = [
        {'action': 'checks', 'amount': 0, 'player': 'bb'},
        {'action': 'bets', 'amount': 400, 'player': 'co'},
        {'action': 'calls', 'amount': 400, 'player': 'bb'}
    ]
...
def sample_three():
    ...
    turn_actions = [
        {'action': 'bets', 'amount': 16000, 'player': 'sb'},
        {'action': 'calls', 'amount': 16000, 'player': 'bb'},
        {'action': 'calls', 'amount': 16000, 'player': 'utg1'},
        {'action': 'calls', 'amount': 16000, 'player': 'utg2'},
        {'action': 'calls', 'amount': 16000, 'player': 'lj'},
        {'action': 'calls', 'amount': 16000, 'player': 'hj'},
        {'action': 'calls', 'amount': 16000, 'player': 'co'}
    ]

    actions = [
        {'action': 'bets', 'amount': 32000, 'player': 'sb'},
    ]
