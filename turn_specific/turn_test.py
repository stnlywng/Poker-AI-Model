...
from turn_testing_samples import *


def load_model(model_path='../models/poker_model_turn.pth'):
...
def create_sample_gamestate(hole_cards, flop_cards, turn_card, position, num_players, blinds, stacks, ante, preflop_actions, flop_actions, actions):
